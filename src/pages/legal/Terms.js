...
const Terms = () => {
    ...
    return (
        <React.Fragment>
            <Helmet>
                <title>CryptoChat - Terms</title>
                <meta name="description" content="Read about prohibited uses and more."></meta>
                <link rel="stylesheet" href="/styles/Terms.css"></link>
            </Helmet>
            <div class="chatbox-parent">
                <div class="chatbox-child">
                    <div class="chatbox-header">
                        <h1 class="chatbox-title">CryptoChat - Terms</h1>
                        <h2 class="chatbox-subtitle">
                            Read about prohibited uses and more.
                        </h2>
                    </div>
                    ...
                    <p class="textcontent">
                        These terms and conditions ("Agreement") set forth the
                                                                    ...
                                                                    cryptochat.dev website ("Website" or "Service") and any of
                                                                    ...
                                                                    ("Operator", "we", "us" or "our"). By accessing and using
                                                                    ...
                                                                    accept this Agreement and may not access and use the Website
                                                                    and Services. You acknowledge that this Agreement is a
                                                                    contract between you and the Operator, even though it is
                                                                    electronic and is not physically signed by you, and it
                                                                    governs your use of the Website and Services. This terms and
                                                                    conditions policy was created with the help of the terms and
                                                                    conditions generator at
                                                                    https://www.websitepolicies.com/terms-and-conditions-generator
                    </p>

                    <h3 class="header">Age requirement</h3>
                    <p class="textcontent">
                        You must be at least 18 years of age to use the Website and
                                                                    Services. By using the Website and Services and by agreeing
                                                                    to this Agreement you warrant and represent that you are at
                                                                    least 18 years of age.
                    </p>

                    <h3 class="header">User content</h3>
                    <p class="textcontent">
                        We do not own any data, information or material
                                                                    (collectively, "Content") that you submit on the Website in
                                                                    ...
                                                                    Unless specifically permitted by you, your use of the Website and
                    ...
                    <h3 class="header">Adult content</h3>
                    <p class="textcontent">
                        Please be aware that there may be certain adult or mature
                                                                    content available on the Website. Where there is mature or
                                                                    adult content, individuals who are less than 18 years of age
                                                                    or are not permitted to access such content under the laws
                                                                    of any applicable jurisdiction may not access such content.
                                                                    If we learn that anyone under the age of 18 seeks to conduct
                                                                    a transaction through the Services, we will require verified
                                                                    parental consent, in accordance with the Children's Online
                                                                    Privacy Protection Act of 1998 ("COPPA"). Certain areas of
                                                                    the Website and Services may not be available to children
                                                                    under 18 under any circumstances.
                    </p>

                    <h3 class="header">Backups</h3>
                    <p class="textcontent">
                    ...
                    <h3 class="header">Links to other resources</h3>
                    <p class="textcontent">
                    ...
                    <h3 class="header">Prohibited uses</h3>
                    <p class="textcontent">
                    ...
                    <h3 class="header">Limitation of liability</h3>
                    <p class="textcontent">
                        To the fullest extent permitted by applicable law, in no
                                                                    ...
                                                                    services will be limited to an amount greater of one dollar
                    ...
                    <h3 class="header">Indemnification</h3>
                    <p class="textcontent">
                    ...
                    <h3 class="header">Severability</h3>
                    <p class="textcontent">
                    ...
                    <h3 class="header">Changes and amendments</h3>
                    <p class="textcontent">
                        We reserve the right to modify this Agreement or its terms
                                                                    ...
                                                                    bottom of this page. Continued use of the Website and
                                                                    Services after any such changes shall constitute your
                                                                    consent to such changes.
                    </p>

                    <h3 class="header">Acceptance of these terms</h3>
                    <p class="textcontent">
                    ...
                    <h3 class="header">Contacting us</h3>
                    <p class="textcontent">
